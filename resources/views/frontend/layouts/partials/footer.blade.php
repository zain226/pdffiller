<footer class="footer"
    style="background-image: url('{{ asset('frontend/assets/images/svg-map.svg') }}'); background-repeat: no-repeat; background-position: center;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 py-lg-5">
                <div class="footer-py-60 text-center">
                    <a href="#" class="logo-footer">
                        <img src="{{ asset('frontend/assets/images/logo-light.png') }}" class="m-auto" height="32"
                            alt="">
                    </a>
                    <p class="mt-4 para-desc mx-auto">Start working with Landrick that can provide everything you need
